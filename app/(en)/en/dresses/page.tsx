...
export const metadata: Metadata = {
  ...
  description:
    "MADAMOON wedding dresses: mermaid, ball gown, sheath, A-line, minimalist, two-in-one. The collections of five designers, to try on by appointment in Paris 10e.",
