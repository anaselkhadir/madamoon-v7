...
export const SILHOUETTES: Silhouette[] = [
  { nom: "Sirène", ancre: "sirene", note: "Féminine et sensuelle", robe: "uma", vue: 1 },
  { nom: "Princesse", ancre: "princesse", note: "Raffinée et solennelle", robe: "addison", vue: 1 },
  { nom: "Fluide", ancre: "fluide", note: "Souple et légère", robe: "adularia", vue: 1 },
  { nom: "Trapèze", ancre: "trapeze", note: "Juste et intemporelle", robe: "solana", vue: 1 },
  {
    nom: "Minimaliste",
    ancre: "minimaliste",
